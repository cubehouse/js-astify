...
Mixin.create('functions', function(o){
  ...
  define(o, [
    function declare(vars){
      ...
      var decls = this.selectLocal('var');
      if (decls.length) {
        var decl = decls[0];
      } else {
        var decl = $('#var', 'var');
...
nodeTypes.register(ArrowFunctionExpression, Expression, ['function', 'arrow'], [
  ...
  function toExpression(){
    ...
    var func = $('#function', null, this.params, body);
...
BinaryExpression.operators = {
  ...
  'in'          : function IS_IN(r) { return this in r },
  'delete'      : function DELETE(r) { return delete this[r] },
  'instanceof'  : function IS_INSTANCE(r) { return this instanceof r }
};
...
UnaryExpression.operators = {
  ...
  'void'        : function VOID(){ return void this },
  'typeof'      : function TYPEOF(){ return typeof this }
};

UpdateExpression.operators = {
  '++'         : function INCREMENT(){ return ++this },
  '--'         : function DECREMENT(){ return --this },
  '_++'         : function PRE_INCREMENT(){ return ++this },
  '_--'         : function PRE_DECREMENT(){ return --this },
  '++_'         : function POST_INCREMENT(){ return this++ },
  '--_'         : function POST_DECREMENT(){ return this-- }
};
