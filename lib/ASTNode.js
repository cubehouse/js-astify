...
AssignmentExpression.operators = {
  '='   : function SET(a,b){ return a = b },
  '*='  : function SET_MULTIPLY(a,b){ return a * b },
  '/='  : function SET_DIVIDE(a,b){ return a / b },
  '%='  : function SET_MOD(a,b){ return a % b },
  '+='  : function SET_ADD(a,b){ return a + b },
  '-='  : function SET_SUBTRACT(a,b){ return a - b },
  '<<=' : function SET_LEFT_SHIFT(a,b){ return a << b },
  '>>=' : function SET_RIGHT_SHIFT(a,b){ return a >> b },
  '>>>=': function SET_SIGNED_RIGHT_SHIFT(a,b){ return a >>> b },
  '&='  : function SET_AND(a,b){ return a & b },
  '^='  : function SET_XOR(a,b){ return a ^ b },
  '|='  : function SET_OR(a,b){ return a | b },
};
...
BinaryExpression.operators = {
  ...
  '>>'        : function RIGHT_SHIFT(a,b){ return a >> b },
  '<<'        : function LEFT_SHIFT(a,b){ return a << b },
  '>>>'       : function SIGNED_RIGHT_SHIFT(a,b){ return a >>> b },
  '!=='       : function IS_INEQUAL(a,b){ return a !== b },
  '==='       : function IS_EQUAL(a,b){ return a === b },
  '!='        : function IS_DIFFERENT(a,b){ return a != b },
  '=='        : function IS_SIMILAR(a,b){ return a == b },
  '>'         : function IS_GREATER(a,b){ return a > b },
  '<'         : function IS_LESS(a,b){ return a < b },
  '>='        : function IS_EQ_OR_GREATER(a,b){ return a >= b },
  '<='        : function IS_EQ_OR_LESS(a,b){ return a <= b },
  'in'        : function IS_IN(a,b){ return a in b },
  'instanceof': function IS_INSTANCE(a,b){ return a instanceof b },
};
...
UpdateExpression.operators = {
  '_++': function PRE_INCREMENT(a){ return ++a },
  '_--': function PRE_DECREMENT(a){ return --a },
  '++_': function POST_INCREMENT(a){ return a++ },
  '--_': function POST_DECREMENT(a){ return a-- },
};
UpdateExpression.operators['++'] = UpdateExpression.operators['_++']
UpdateExpression.operators['--'] = UpdateExpression.operators['_--']
