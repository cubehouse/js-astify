...
var FunctionDeclaration = new Declaration(['function', 'functiondecl'], [
  function FunctionDeclaration(id, params, body, rest){ //generator, rest, defaults
    if (id == null)
    ...
    this.rest = assertInstance(rest, [null, Identifier]);
    prep(this);
  },
...
var FunctionExpression = new Expression(['function', 'functionexpr'], [
  function FunctionExpression(id, params, body, rest){
    FunctionDeclaration.call(this, id || '', params, body, rest);
    if (id == null)
      this.id = null;
    prep(this);
  },
...
var ArrowFunctionExpression = new Expression(['function', 'arrow'], [
  function ArrowFunctionExpression(params, body, rest){
    if (!body || body instanceof Array)
      body = create('#block', body);
    this.params = new ASTArray;
    this.body = assertInstance(body, [BlockStatement, Expression]);
