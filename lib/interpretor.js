...
function GlobalScope(context){
  ...
  var _Function = create(FunctionPrototype, {
    name: { value: 'Function' },
    length: { value: 1 },
    prototype: { value: create(ObjectPrototype) }
  });
  var _Object = create(FunctionPrototype, {
    name: { value: 'Object' },
    length: { value: 1 },
    prototype: { value: create(ObjectPrototype) }
  });
  ...
  for (var k in builtins) {
    var thunk = new Thunk(this, k, 1);
    thunk.call = builtins[k].call;
    thunk.construct = builtins[k].construct;
    thunk.locked = true;
    this.builtins[k] = thunk.instantiate();
  }

  this.record = create(this.builtins.Object.prototype);
